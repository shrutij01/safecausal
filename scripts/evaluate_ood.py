...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Evaluate OOD data with steering vectors")
    ...
    parser.add_argument("--ood-data", required=True, help="Path to OOD data file")
    parser.add_argument("--steering-vector", required=True, help="Path to steering vector file")
    parser.add_argument(
        "--modeltype", 
        required=True, 
    ...
    parser.add_argument("--modeldir", help="Path to model directory (for SSAE)")
