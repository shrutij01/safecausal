...
embedding_files=(
    "/network/scratch/j/joshi.shruti/psp/binary_1_1/binary_1_1_embeddings_layer_32.h5"
)
data_configs=(
    "/network/scratch/j/joshi.shruti/psp/binary_1_1/binary_1_1_32_config.yaml"
)
alphas=(
    "--alpha 11" "--alpha 5"
)
