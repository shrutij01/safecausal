...
embedding_files=(
    "/network/scratch/j/joshi.shruti/ssae/truthful_qa/truthful_qa_embeddings_layer_32.h5"
)
data_configs=(
    "/network/scratch/j/joshi.shruti/ssae/truthful_qa/truthful_qa_32_config.yaml"
)
epochs=(
    "--num-epochs 20000"
)
