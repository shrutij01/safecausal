...
embedding_files=(
    ...
    "/network/scratch/j/joshi.shruti/ssae/eng-german/eng-german_gemma2_25_last_token.h5"
    "/network/scratch/j/joshi.shruti/ssae/eng-german/eng-german_pythia70m_5_last_token.h5"
    "/network/scratch/j/joshi.shruti/ssae/masc-fem-eng/masc-fem-eng_gemma2_25_last_token.h5"
    "/network/scratch/j/joshi.shruti/ssae/masc-fem-eng/masc-fem-eng_pythia70m_5_last_token.h5"
...
data_configs=(
    ...
    "/network/scratch/j/joshi.shruti/ssae/eng-german/eng-german_gemma2_25_last_token.yaml"
    "/network/scratch/j/joshi.shruti/ssae/eng-german/eng-german_pythia70m_5_last_token.yaml"
...
encoding_dims=(
    "--oc 1"    # overcompleteness factor = num-concepts = 1
)
schedules=(
