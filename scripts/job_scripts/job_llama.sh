...
embedding_files=(
    "/network/scratch/j/joshi.shruti/ssae/refusal/refusal_llama3_31_last_token.h5"
    "/network/scratch/j/joshi.shruti/ssae/sycophancy/sycophancy_llama3_31_last_token.h5"
    "/network/scratch/j/joshi.shruti/ssae/categorical-contrastive/categorical-contrastive_llama3_31_last_token.h5"
    "/network/scratch/j/joshi.shruti/ssae/truthful-qa/truthful-qa_llama3_31_last_token.h5"
    "/network/scratch/j/joshi.shruti/ssae/bias-in-bios/bias-in-bios_llama3_31_last_token.h5"
)

data_configs=(
    "/network/scratch/j/joshi.shruti/ssae/refusal/refusal_llama3_31_last_token.yaml"
    "/network/scratch/j/joshi.shruti/ssae/sycophancy/sycophancy_llama3_31_last_token.yaml"
    "/network/scratch/j/joshi.shruti/ssae/categorical-contrastive/categorical-contrastive_llama3_31_last_token.yaml"
    "/network/scratch/j/joshi.shruti/ssae/truthful-qa/truthful-qa_llama3_31_last_token.yaml"
    "/network/scratch/j/joshi.shruti/ssae/bias-in-bios/bias-in-bios_llama3_31_last_token.yaml"
)
                                ...
                                for renorm_epoch in "${renorm_epochs[@]}"; do
                                    for epochs in "${num_epochs[@]}"; do
                                        for seed in "${seeds[@]}"; do
                                            ...
                                            echo "python ssae.py --quick ${embedding_file} ${data_config} ${oc} ${lr} ${loss_type} ${norm_type} ${target} ${batch_size} ${schedule} ${renorm_epoch} ${epochs} ${seed}" >> "${script_name}"
