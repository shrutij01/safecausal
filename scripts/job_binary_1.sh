                    ...
                    for norm_type in "${norm_types[@]}"; do
                        for dual_lr in "${dual_lrs[@]}"; do
                            for seed in "${seeds[@]}"; do
                                ...
                                echo "python linear_sae.py --embeddings-file ${embedding_file} --data-config-file ${data_config} ${alpha} ${primal_lr} ${dual_lr} ${norm_type} ${indicator_threshold} ${seed}" >> "${script_name}"
